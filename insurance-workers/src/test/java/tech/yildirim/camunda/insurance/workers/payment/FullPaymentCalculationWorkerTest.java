...
@DisplayName("FullPaymentCalculationWorker Tests")
class FullPaymentCalculationWorkerTest {
  ...
  private FullPaymentCalculationWorker fullPaymentCalculationWorker;

  @BeforeEach
  void setUp() {
    fullPaymentCalculationWorker = new FullPaymentCalculationWorker(claimService);
  }
  ...
  class TopicNameTests {
    ...
    void shouldReturnCorrectTopicName() {
      // When
      String topicName = fullPaymentCalculationWorker.getTopicName();

      // Then
      assertThat(topicName).isEqualTo("insurance.payment.calculate-full");
    }
  }
  ...
  class PaymentPercentageTests {
    ...
    void shouldReturnCorrectPaymentPercentage() {
      // When
      int percentage = fullPaymentCalculationWorker.getPaymentPercentage();
  ...
  class AutoClaimPaymentCalculationTests {
    ...
    @Test
    @DisplayName("Should calculate 100% payment for auto claim successfully")
    void shouldCalculate100PercentPaymentForAutoClaimSuccessfully() {
      // Given
      BigDecimal invoiceAmount = new BigDecimal("1000.00");
      BigDecimal expectedApprovedAmount = new BigDecimal("1000.00"); // 100%
      Long claimId = 123L;
      ...
      // When
      fullPaymentCalculationWorker.executeBusinessLogic(externalTask, externalTaskService);
  ...
  class HomeClaimPaymentCalculationTests {
    ...
    @Test
    @DisplayName("Should calculate 100% payment for home claim successfully")
    void shouldCalculate100PercentPaymentForHomeClaimSuccessfully() {
      // Given
      BigDecimal invoiceAmount = new BigDecimal("2500.00");
      BigDecimal expectedApprovedAmount = new BigDecimal("2500.00"); // 100%
      Long claimId = 456L;
      String claimType = "HOME";
      String invoiceDetails = "Roof repair invoice from partnered contractor";
  ...
  class HealthClaimPaymentCalculationTests {
    ...
    @Test
    @DisplayName("Should calculate 100% payment for health claim successfully")
    void shouldCalculate100PercentPaymentForHealthClaimSuccessfully() {
      // Given
      BigDecimal invoiceAmount = new BigDecimal("750.00");
      BigDecimal expectedApprovedAmount = new BigDecimal("750.00"); // 100%
      Long claimId = 789L;
      String claimType = "HEALTH";
      String invoiceDetails = "Medical treatment invoice from partnered provider";
  ...
  class InputValidationTests {
    ...
    void shouldHandleCaseInsensitiveClaimType() {
      ...
      BigDecimal expectedApprovedAmount = new BigDecimal("1000.00"); // 100%
      Long claimId = 123L;
      String claimType = "home"; // lowercase
    ...
    void shouldHandleClaimTypeWithSpaces() {
      ...
      BigDecimal expectedApprovedAmount = new BigDecimal("1000.00"); // 100%
      Long claimId = 123L;
      String claimType = "  HEALTH  "; // with spaces
  ...
  class BusinessLogicTests {
    ...
    @Test
    @DisplayName("Should preserve exact amount for partnered provider payments")
    void shouldPreserveExactAmountForPartneredProviderPayments() {
      // Given
      BigDecimal invoiceAmount = new BigDecimal("1234.56");
      BigDecimal expectedApprovedAmount = new BigDecimal("1234.56"); // Exact same amount for 100%
      Long claimId = 123L;
      String claimType = "AUTO";
      String invoiceDetails = "Partnered provider repair invoice";
    ...
    @Test
    @DisplayName("Should handle large invoice amounts correctly")
    void shouldHandleLargeInvoiceAmountsCorrectly() {
      // Given
      BigDecimal invoiceAmount = new BigDecimal("99999.99");
      BigDecimal expectedApprovedAmount = new BigDecimal("99999.99"); // Same amount for 100%
      Long claimId = 123L;
      String claimType = "HOME";
      ...
      when(externalTask.getVariable(ProcInstVars.CLAIM_ID)).thenReturn(claimId);
      when(externalTask.getVariable(ProcInstVars.CLAIM_TYPE)).thenReturn(claimType);
      when(externalTask.getVariable(ProcInstVars.INVOICE_DETAILS)).thenReturn("Large repair invoice");
      when(claimService.getHomeClaimById(claimId)).thenReturn(homeClaim);
