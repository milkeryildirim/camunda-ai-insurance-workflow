...
/**
 * Comprehensive test suite for DocumentController class.
 * Tests all REST endpoints with various scenarios including validation, error handling, and success cases.
 */
...
class DocumentControllerTest {
    ...
    class UploadDocumentTests {
        ...
        void shouldUploadDocumentSuccessfully() throws Exception {
            // Given
            when(documentService.createDocument(eq(CLAIM_NUMBER), eq(DOCUMENT_TYPE), any(MockMultipartFile.class)))
    ...
    class DownloadDocumentTests {
        ...
        void shouldDownloadDocumentSuccessfully() throws Exception {
            ...
            DocumentService.FileDownloadResult downloadResult = DocumentService.FileDownloadResult.builder()
                    .fileName(TEST_FILE_NAME)
                    .contentType(TEST_CONTENT_TYPE)
            ...
            // When & Then
            mockMvc.perform(get(API_BASE_PATH + "/download")
                            .param("claimNumber", CLAIM_NUMBER)
                            .param("documentType", DOCUMENT_TYPE.name()))
                    .andDo(print())
    ...
    class GetDocumentInfoTests {
        ...
        void shouldGetDocumentInfoSuccessfully() throws Exception {
            ...
            // When & Then
            mockMvc.perform(get(API_BASE_PATH + "/info")
                            .param("claimNumber", CLAIM_NUMBER)
                            .param("documentType", DOCUMENT_TYPE.name()))
                    .andDo(print())
                    .andExpect(status().isOk())
        ...
        void shouldReturn400ForEmptyClaimNumber() throws Exception {
            ...
            verify(documentService, never()).findDocumentByClaimAndType(any(), any());
        }
    ...
    class IntegrationTests {
        ...
        void shouldHandleAdjusterReportDocumentType() throws Exception {
            // Given
            DocumentDTO adjusterReportDTO = DocumentDTO.builder()
                    .id(2L)
                    .claimNumber(CLAIM_NUMBER)
            ...
            verify(documentService, times(1)).findDocumentByClaimAndType(CLAIM_NUMBER, DocumentType.ADJUSTER_REPORT);
        }
        ...
        void shouldHandleMaximumAllowedClaimNumberLength() throws Exception {
            ...
            verify(documentService, times(1)).findDocumentByClaimAndType(maxLengthClaimNumber, DOCUMENT_TYPE);
        }
        ...
        void shouldHandleSpecialCharactersInClaimNumber() throws Exception {
            ...
            verify(documentService, times(1)).findDocumentByClaimAndType(specialClaimNumber, DOCUMENT_TYPE);
        }
        ...
        void shouldHandleDifferentFileTypesInUpload() throws Exception {
            ...
            DocumentDTO imageDocumentDTO = DocumentDTO.builder()
                    .id(3L)
                    .claimNumber(CLAIM_NUMBER)
                    .documentType(DOCUMENT_TYPE)
        ...
        void shouldHandleValidationEdgeCases() throws Exception {
            ...
            verify(documentService, times(1)).findDocumentByClaimAndType(exactLengthClaimNumber, DOCUMENT_TYPE);
            ...
            // Verify service was not called for invalid request
            verify(documentService, never()).findDocumentByClaimAndType(eq(tooLongClaimNumber), any());
        }
    }
}
